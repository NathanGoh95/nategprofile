 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(e){function t(j,T){var R=j.length;j.push(T);e:for(;0<R;){var A=R-1>>>1,q=j[A];if(0<i(q,T))j[A]=T,j[R]=q,R=A;else break e}}function n(j){return j.length===0?null:j[0]}function r(j){if(j.length===0)return null;var T=j[0],R=j.pop();if(R!==T){j[0]=R;e:for(var A=0,q=j.length,wt=q>>>1;A<wt;){var Ie=2*(A+1)-1,lt=j[Ie],Me=Ie+1,be=j[Me];if(0>i(lt,R))Me<q&&0>i(be,lt)?(j[A]=be,j[Me]=R,A=Me):(j[A]=lt,j[Ie]=R,A=Ie);else if(Me<q&&0>i(be,R))j[A]=be,j[Me]=R,A=Me;else break e}}return T}function i(j,T){var R=j.sortIndex-T.sortIndex;return R!==0?R:j.id-T.id}if(typeof performance=="object"&&typeof performance.now=="function"){var o=performance;e.unstable_now=function(){return o.now()}}else{var l=Date,a=l.now();e.unstable_now=function(){return l.now()-a}}var s=[],u=[],m=1,g=null,p=3,y=!1,w=!1,x=!1,_=typeof setTimeout=="function"?setTimeout:null,d=typeof clearTimeout=="function"?clearTimeout:null,c=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function f(j){for(var T=n(u);T!==null;){if(T.callback===null)r(u);else if(T.startTime<=j)r(u),T.sortIndex=T.expirationTime,t(s,T);else break;T=n(u)}}function v(j){if(x=!1,f(j),!w)if(n(s)!==null)w=!0,tr(C);else{var T=n(u);T!==null&&Xt(v,T.startTime-j)}}function C(j,T){w=!1,x&&(x=!1,d(z),z=-1),y=!0;var R=p;try{for(f(T),g=n(s);g!==null&&(!(g.expirationTime>T)||j&&!$e());){var A=g.callback;if(typeof A=="function"){g.callback=null,p=g.priorityLevel;var q=A(g.expirationTime<=T);T=e.unstable_now(),typeof q=="function"?g.callback=q:g===n(s)&&r(s),f(T)}else r(s);g=n(s)}if(g!==null)var wt=!0;else{var Ie=n(u);Ie!==null&&Xt(v,Ie.startTime-T),wt=!1}return wt}finally{g=null,p=R,y=!1}}var E=!1,k=null,z=-1,B=5,I=-1;function $e(){return!(e.unstable_now()-I<B)}function Yt(){if(k!==null){var j=e.unstable_now();I=j;var T=!0;try{T=k(!0,j)}finally{T?Gt():(E=!1,k=null)}}else E=!1}var Gt;if(typeof c=="function")Gt=function(){c(Yt)};else if(typeof MessageChannel<"u"){var Jr=new MessageChannel,Fo=Jr.port2;Jr.port1.onmessage=Yt,Gt=function(){Fo.postMessage(null)}}else Gt=function(){_(Yt,0)};function tr(j){k=j,E||(E=!0,Gt())}function Xt(j,T){z=_(function(){j(e.unstable_now())},T)}e.unstable_IdlePriority=5,e.unstable_ImmediatePriority=1,e.unstable_LowPriority=4,e.unstable_NormalPriority=3,e.unstable_Profiling=null,e.unstable_UserBlockingPriority=2,e.unstable_cancelCallback=function(j){j.callback=null},e.unstable_continueExecution=function(){w||y||(w=!0,tr(C))},e.unstable_forceFrameRate=function(j){0>j||125<j?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):B=0<j?Math.floor(1e3/j):5},e.unstable_getCurrentPriorityLevel=function(){return p},e.unstable_getFirstCallbackNode=function(){return n(s)},e.unstable_next=function(j){switch(p){case 1:case 2:case 3:var T=3;break;default:T=p}var R=p;p=T;try{return j()}finally{p=R}},e.unstable_pauseExecution=function(){},e.unstable_requestPaint=function(){},e.unstable_runWithPriority=function(j,T){switch(j){case 1:case 2:case 3:case 4:case 5:break;default:j=3}var R=p;p=j;try{return T()}finally{p=R}},e.unstable_scheduleCallback=function(j,T,R){var A=e.unstable_now();switch(typeof R=="object"&&R!==null?(R=R.delay,R=typeof R=="number"&&0<R?A+R:A):R=A,j){case 1:var q=-1;break;case 2:q=250;break;case 5:q=1073741823;break;case 4:q=1e4;break;default:q=5e3}return q=R+q,j={id:m++,callback:T,priorityLevel:j,startTime:R,expirationTime:q,sortIndex:-1},R>A?(j.sortIndex=R,t(u,j),n(s)===null&&j===n(u)&&(x?(d(z),z=-1):x=!0,Xt(v,R-A))):(j.sortIndex=q,t(s,j),w||y||(w=!0,tr(C))),j},e.unstable_shouldYield=$e,e.unstable_wrapCallback=function(j){var T=p;return function(){var R=p;p=T;try{return j.apply(this,arguments)}finally{p=R}}}})(Pc);jc.exports=Pc;var Rp=jc.exports;/**
 * @license React
...
`,zg=()=>{const{isOpen:e,toggle:t,setPageState:n}=N.useContext(bn);return h.jsxs(Eg,{isOpen:e,onClick:t,children:[h.jsx(Pg,{onClick:()=>t(),children:h.jsx(jg,{})}),h.jsx(_g,{children:h.jsxs($g,{children:[h.jsx(xl,{onClick:()=>n("about-me"),children:"About Me"}),h.jsx(xl,{onClick:()=>n("experience"),children:"Experience"}),h.jsx(xl,{onClick:()=>n("contact"),children:"Contact"})]})})]})},oc="80px",ce={mobile:"430px",tablet:"768px",desktop:"1024px"},Ng=$.div`
  background: #0d1321;
...
`,t1="/nategprofile/assets/react-logo-56311bed.svg",n1="/nategprofile/assets/nextjs-logo-d0aad26e.svg",r1="/nategprofile/assets/javascript-logo-348a59a3.svg",i1="/nategprofile/assets/typescript-logo-01c84e42.svg",o1="/nategprofile/assets/html5-logo-0fe8a477.svg",l1="/nategprofile/assets/css3-logo-3e1f6441.svg",a1="/nategprofile/assets/tailwind-logo-9dcfbd9e.svg",s1="/nategprofile/assets/mobx-logo-3dfcabba.svg";/**
